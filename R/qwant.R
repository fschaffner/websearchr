...
qwant <- function(search.terms, lang = c("en", "de", "es", "fr")) {
  ...
  if (grepl("en", lang)) {
    ...
    browseURL(paste0("https://www.qwant.com/?q=", URLencode(search.terms), "&l=en"))
  }

  # if system language contains "de" use German version
  else if (grepl("de", lang)) {
    message("\u00D6ffne Qwant Suche f\u00FCr \"", search.terms, "\" im Browser")
    browseURL(paste0("https://www.qwant.com/?q=", URLencode(search.terms), "&l=de"))
  }
  
  # if system language contains "es" use Spanish Wikipedia version
  else if (grepl("es", lang)) {
    message("Abriendo b\u00FAsqueda de Qwant \"", search.terms, "\" en browser")
    browseURL(paste0("https://www.qwant.com/?q=", URLencode(search.terms), "&l=es"))
  }
  ...
  # if system language contains "fr" use French Wikipedia version
    ...
    browseURL(paste0("https://www.qwant.com/?q=", URLencode(search.terms), "&l=fr"))
  }
